...
deg_dir <- "~/neuroblastoma/results/ATAC-seq/ATAC-seq_drug_treatment_CM_with_bathc_variable/"
...
## IMPORTANT DIFFERENCE - we don;t use cell line variable here
#design(drg_trtm_ATAC) <- as.formula("~ batch + cell_line + time")
...
# # UNCOMENT ONLY FOR PROMOTER ANLAYSIS
