...
dr_list <- list.dirs("/home/abykov/neuroblastoma/results/CnR/CnR_LILY/", recursive = FALSE)

for(folder_name in dr_list){
  
  if(folder_name == "/home/abykov/neuroblastoma/results/CnR/CnR_LILY//SK-N-SH-M_H3K27ac_R2"){next}
  ...
  args <- c(dummy1="",dummy2="",dummy3="",
            ...
            distFromTSS = 3000,
            transcriptomeFile = "/home/abykov/neuroblastoma/resources/hg38_refseq_noChr.ucsc",
            faiFileToCreateBigWig = "/home/abykov/neuroblastoma/resources/Homo_sapiens_Genome.GRCh38.102.fa.fai")
...
res_dir <- "~/neuroblastoma/results/CnR/CnR_LILY/"
...
#CLB-Ma Enhancers
Grange_CLB_Ma_A_merged <- reduce(c(SE_list[["CLB-Ma-A_H3K27ac_R1"]], 
                                   SE_list[["CLB-Ma-A_H3K27ac_R2"]],
                                   SE_list[["CLB-Ma-ADR_H3K27ac_R1"]],
                                   SE_list[["CLB-Ma-ADR_H3K27ac_R2"]]), drop.empty.ranges = F, min.gapwidth = 1)
Grange_CLB_Ma_M_merged <- reduce(c(SE_list[["CLB-Ma-M_H3K27ac_R1"]], 
                                   SE_list[["CLB-Ma-M_H3K27ac_R2"]],
                                   SE_list[["CLB-MA-MES_H3K27ac_R1"]],
                                   SE_list[["CLB-MA-MES_H3K27ac_R2"]]), drop.empty.ranges = F, min.gapwidth = 1)
...
Export_my_BED(Grange_CLB_Ma_A, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(Grange_CLB_Ma_M, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(Grange_CLB_Ma_AM_reduced, "~/neuroblastoma/temp_results/BEDs/")


# Normalization to the length of a SE 
# DBobj_list_const must be loaded separately
DBobj_list_cons <- readRDS("~/neuroblastoma/results/CnR/DBobj_list_cons.RDS")
...
#pdf(file = "~/neuroblastoma/results/CnR/CnR_LILY/heatmap_SHs_CMs.pdf")
...
# Now - SKN-N
Grange_SK_N_SH_A_merged <- reduce(c(SE_list[["SK-N-SH-A_H3K27ac_R1"]],
                                    SE_list[["SK-N-SH-A_H3K27ac_R2"]],
                                    SE_list[["SK-N-SH-ADR_H3K27ac_R1"]],
                                    SE_list[["SK-N-SH-ADR_H3K27ac_R2"]]), 
                                  drop.empty.ranges = F, min.gapwidth = 1)
Grange_SK_N_SH_M_merged <- reduce(c(SE_list[["SK-N-SH-M_H3K27ac_R1"]],
                                    SE_list[["SK-N-SH-M_H3K27ac_R2"]],
                                    SE_list[["SK-N-SH-MES_H3K27ac_R2"]]), drop.empty.ranges = F, min.gapwidth = 1)
...
Export_my_BED(Grange_SK_N_SH_A, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(Grange_SK_N_SH_M, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(Grange_SK_N_SH_AM_reduced, "~/neuroblastoma/temp_results/BEDs/")
...
Export_my_BED(CLB_SKN_A, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(CLB_SKN_M, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(CLB_SKN_AM, "~/neuroblastoma/temp_results/BEDs/")
...
Export_my_BED(CLB_SKN_A_u, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(CLB_SKN_M_u, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(CLB_SKN_AM_u, "~/neuroblastoma/temp_results/BEDs/")

Export_my_BED(SKN_M_u, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(SKN_A_u, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(CLB_M_u, "~/neuroblastoma/temp_results/BEDs/")
Export_my_BED(CLB_A_u, "~/neuroblastoma/temp_results/BEDs/")
...
# NOTE make sure that the BEDs contain chr tag before the chromosome names 
# Then load the files:
...
############# GSEA for k-975 24h
# load genes from RNA-seq MES/ADR-specific genes
RNA_SEQ_data <- openxlsx2::read_xlsx("~/neuroblastoma/results/RNA-seq/RNA-seq_yap_taz_inhibition/cell_type_24h_vs_control.xlsx", sheet = 1)
mes_adrn_gene_list <- RNA_SEQ_data %>%
...
############# GSEA for k-975 48h
# load genes from RNA-seq MES/ADR-specific genes
RNA_SEQ_data <- openxlsx2::read_xlsx("~/neuroblastoma/results/RNA-seq/RNA-seq_yap_taz_inhibition/cell_type_48h_vs_control.xlsx", sheet = 1)
mes_adrn_gene_list <- RNA_SEQ_data %>%
