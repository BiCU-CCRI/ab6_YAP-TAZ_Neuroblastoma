...
extract_results_nextflow_output <- function(dds_object = NULL,
                                            dds_result = NULL,
                                            coeff_name = NULL,
                                            cond_numerator = NULL,
                                            cond_denominator = NULL,
  ...
  normalized_counts_AddedMean <-   meanExprsPerGroup_nextflow(dds_object=dds_object,
                                                              cond_numerator=cond_numerator,
                                                              cond_denominator=cond_denominator,
                                                              variable = cond_variable)
...
meanExprsPerGroup_nextflow <- function(dds_object=NULL, 
                                       #condition_test=NULL,
                                       variable=NULL,
                                       cond_numerator=NULL, 
                                       cond_denominator=NULL){
