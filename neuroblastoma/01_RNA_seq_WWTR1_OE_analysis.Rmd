...
suppressPackageStartupMessages({
  ...
  # Load enhanced utility functions
...
ggsave(
  filename = paste0(PATHS$results_dir, "PCA_WWTR1_only_dox_doxTDI_DMSO.pdf"),
  plot = tmp_pca_deg,
...
for(gene_set_to_plot_name in names(gene_set_list)){
 ...
 plot(p)
  ...
  ggsave(
    filename = paste0(PATHS$results_dir, "TDI_vs_DMSO_fgsea_", gene_set_to_plot_name, ".pdf"),
    plot = p,
    width = 20, height = 20, units = "cm"
  )
}
...
for(gene_set_to_plot_name in names(gene_set_list)){
  ...
  ggsave(
    filename = paste0(PATHS$results_dir, "doxTDI_vs_dox_fgsea_", gene_set_to_plot_name, ".pdf"),
    plot = p,
    width = 20, height = 20, units = "cm"
  )
}
...
ggsave(
  filename = paste0(PATHS$results_dir, "PCA_WWTR1_only_dox_doxTDI_DMSO_plus_OGs.pdf"),
  plot = tmp_pca_deg,
  width = 20, height = 20, units = "cm"
)
...
ggsave(
  filename = paste0(PATHS$results_dir, "PCA_WWTR1_only_dox_doxTDI_DMSO_plus_OGs_batch_corrected.pdf"),
