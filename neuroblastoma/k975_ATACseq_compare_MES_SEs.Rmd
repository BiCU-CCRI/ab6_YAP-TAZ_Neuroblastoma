...
results_dir <- "~/workspace/neuroblastoma/results/ATAC-seq_drug_treatment/CLBM-SKNSH_MES_SEs"
...
atac_scores_raw <- read.table(
  file.path(data_dir, "ATACseq/bigWigs/scores_per_transcript_clbm_skn_MESu.tab"),
  header = TRUE,
  sep = "\t",
...
cat(sprintf("Loaded raw accessibility data for %d MES super enhancer regions\n", nrow(atac_scores_raw)))
```
...
# Apply normalization to MES super enhancer data
...
cat(sprintf("\nFinal normalized accessibility data for %d MES super enhancer regions\n", nrow(atac_scores)))
```
