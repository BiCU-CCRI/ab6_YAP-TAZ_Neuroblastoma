...
viabilities <- read.csv(file.path(data_dir, "SK-N-SH_viabilities.csv"))
viabilities <- viabilities %>% rename("ADR" = NumberOfCells_ADR,
...
write.csv(scores, file = file.path(results_dir, "SK-N-SH_reanalysis_v3.csv"))

#calculation of AUC scores STA-NB-8
viabilities <- read.csv(file.path(data_dir, "STA-NB-8_viabilities.csv"))
