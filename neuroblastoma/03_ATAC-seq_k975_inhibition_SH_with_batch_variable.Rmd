...
deg_dir <- "~/neuroblastoma/results/ATAC-seq/ATAC-seq_drug_treatment_SH_with_bathc_variable/"
...
#debug
#all_MES_peaks_MAML2 <- c(mcols(drg_trtm_ATAC)$PeakId[mcols(drg_trtm_ATAC)$Gene.Name == "MAML2"])
...
#heatmap_counts_MAML_spec_genes <- heatmap_counts[rownames(heatmap_counts) %in% all_MES_peaks_MAML2, ]
