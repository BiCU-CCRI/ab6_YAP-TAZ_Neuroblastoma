...
# Set up renv cache directory
renv_cache_dir="envs/renv"
mkdir -p "${renv_cache_dir}"
...
${renv_cache_dir}:/renv/cache,\
/nobackup:/nobackup,\
/research:/research,\
${workspace}:/workspace,\
/nobackup/lab_ccri_bicu/internal/abykov/projects/ab6_soeren_neuroblastoma/adaptation_for_cemm/raw_data:/raw_data,\
${workdir}:/home/${USER}"
# ${rstudio_server_config_dir}:/home/${USER},\
